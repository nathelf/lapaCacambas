...
export default function ClienteFormPage() {
  ...
  const { register, handleSubmit, watch, reset, formState: { errors, isSubmitting } } = useForm<ClienteFormData>({
    ...
    values: clienteExistente ? {
      ...
      motivo: (clienteExistente as any).motivo_bloqueio || '',
      referencia: (clienteExistente as any).referencia || '',
      observacao: (clienteExistente as any).observacao || '',
      enderecoCobranca: (clienteExistente as any).endereco_cobranca || '',
      numeroCobranca: (clienteExistente as any).numero_cobranca || '',
      complementoCobranca: (clienteExistente as any).complemento_cobranca || '',
      cepCobranca: (clienteExistente as any).cep_cobranca || '',
      bairroCobranca: (clienteExistente as any).bairro_cobranca || '',
      cidadeCobranca: (clienteExistente as any).cidade_cobranca || '',
      estadoCobranca: (clienteExistente as any).estado_cobranca || '',
    } : undefined,
  });
  ...
  const buildPayload = (data: ClienteFormData) => ({
    ...
    status: data.status,
    motivo_bloqueio: data.motivo || null,
    referencia: data.referencia || null,
    observacao: data.observacao || null,
    endereco_cobranca: data.enderecoCobranca || null,
    numero_cobranca: data.numeroCobranca || null,
    complemento_cobranca: data.complementoCobranca || null,
    cep_cobranca: data.cepCobranca || null,
    bairro_cobranca: data.bairroCobranca || null,
    cidade_cobranca: data.cidadeCobranca || null,
    estado_cobranca: data.estadoCobranca || null,
  });
